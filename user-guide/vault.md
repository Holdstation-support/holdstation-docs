---
description: >-
  Curious about how to deposit and withdraw funds to Holdstation DeFutures
  Vault? Here are the simple steps:
hidden: true
---
...
**Note:** _Please be aware that if users do not withdraw their USDC during the redemption epoch, all remaining USDC will be automatically re-staked into the Vault._
