...
> _**Important Notes:**_
>
> * _HST Credits are calculated by block._
> * _The amount of HST Credits displayed on the screen is an **Estimate only**. The exact amount of HST Credits earned will be calculated at the end of each epoch._
> * _If you wish to withdraw assets from the Crypto DeFuture Vault, you must make a request and wait for 5 epochs for the request to be processed. Please keep this in mind when planning your withdrawals._
